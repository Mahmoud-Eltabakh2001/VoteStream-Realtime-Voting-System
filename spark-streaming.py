...
# Fix HOME directory to avoid Ivy absolute path errors
os.environ["HOME"] = "/tmp"
os.environ["SPARK_USER"] = "spark"
...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
            ...
            .master("local[*]")
            .config("spark.jars", "/app/spark-sql-kafka-0-10_2.13-3.5.0.jar,/app/postgresql-42.7.1.jar")
